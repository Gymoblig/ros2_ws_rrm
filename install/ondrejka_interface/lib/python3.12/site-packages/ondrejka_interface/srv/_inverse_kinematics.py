...
class InverseKinematics_Event(metaclass=Metaclass_InverseKinematics_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ondrejka_interface/InverseKinematics_Request, 1>',
        'response': 'sequence<ondrejka_interface/InverseKinematics_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ondrejka_interface', 'srv'], 'InverseKinematics_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ondrejka_interface', 'srv'], 'InverseKinematics_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ondrejka_interface.srv import InverseKinematics_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from ondrejka_interface.srv import InverseKinematics_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_InverseKinematics(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ondrejka_interface.srv.InverseKinematics')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ondrejka_interface.srv import _inverse_kinematics
...
class InverseKinematics(metaclass=Metaclass_InverseKinematics):
    from ondrejka_interface.srv._inverse_kinematics import InverseKinematics_Request as Request
    from ondrejka_interface.srv._inverse_kinematics import InverseKinematics_Response as Response
    from ondrejka_interface.srv._inverse_kinematics import InverseKinematics_Event as Event
